...
#' }
#'@author Craig Parman
#'@description \code{getEntityAssociations}  Get assoication for a context



getEntityAssociations<-function (coreApi,entityType,barcode,context,fullMetadata = TRUE, useVerbose=FALSE)
